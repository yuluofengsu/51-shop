...
CREATE TABLE `goods`  (
  ...
  `subcat_id` int(11) NULL DEFAULT NULL,
  `supercat_id` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
...
CREATE TABLE `orders`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) NULL DEFAULT NULL,
  `recevie_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `recevie_address` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
  `recevie_tel` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
CREATE TABLE `subcat`  (
  ...
  `super_cat_id` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
